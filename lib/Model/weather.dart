class Coord {
  ...
  factory Coord.fromJson(Map<String,dynamic> json){
    return Coord(lon: double.parse(json['lon'].toString()),lat: double.parse(json['lat'].toString()));
  }
}
  ...
  factory Main.fromJson(Map<String, dynamic> json) {
    return Main(
      temp: double.parse(json['temp'].toString()),
        ...
        grnd_level:
            json['sea_level'] == null ? 0.0 : double.parse(json['grnd_level'].toString()),
...
class WeatherModel {
  ...
  factory WeatherModel.fromJson(Map<String, dynamic> json) {
    return WeatherModel(coord: Coord.fromJson(json['coord']),
